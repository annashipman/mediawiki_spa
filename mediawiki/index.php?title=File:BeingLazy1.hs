...
<head>
<title>File:BeingLazy1.hs - SPA Wiki</title>
...
wgNamespaceNumber=6,
wgPageName="File:BeingLazy1.hs",
wgTitle="BeingLazy1.hs",
wgAction="view",
wgArticleId=0,
wgIsArticle=true,
wgUserName=null,
...
<body class="mediawiki ltr ns-6 ns-subject page-File_BeingLazy1_hs skin-monobook">
<div id="globalWrapper">
<div id="column-content"><div id="content" >
	<a id="top"></a>
	
	<h1 id="firstHeading" class="firstHeading">File:BeingLazy1.hs</h1>
	<div id="bodyContent">
		<h3 id="siteSub">From SPA Wiki</h3>
		<div id="contentSub"></div>
		<div id="jump-to-nav">Jump to: <a href="./index.php?title=File:BeingLazy1.hs#column-one">navigation</a>, <a href="./index.php?title=File:BeingLazy1.hs#searchInput">search</a></div>
		<!-- start content -->
<ul id="filetoc"><li><a href="./index.php?title=File:BeingLazy1.hs#file">File</a></li>
<li><a href="./index.php?title=File:BeingLazy1.hs#filehistory">File history</a></li>
<li><a href="./index.php?title=File:BeingLazy1.hs#filelinks">File links</a></li></ul><div class="fullMedia">
<p><span class="dangerousLink"><a href="images/b/bd/BeingLazy1.hs" class="internal" title="BeingLazy1.hs">BeingLazy1.hs</a></span>‎
<span class="fileInfo">(file size: 2 KB, MIME type: text/plain)</span>
</p>
</div>
...
<tr><td>current</td><td class='filehistory-selected' style='white-space: nowrap;'><a href="images/b/bd/BeingLazy1.hs">11:06, 2 June 2011</a></td><td> <span style='white-space: nowrap;'>(2 KB)</span></td><td><a href="./index.php?title=Special:Contributions%252FMaintenance_script" title="Special:Contributions/Maintenance script" class="mw-userlink">Maintenance script</a> <span style='white-space: nowrap;'> <span class="mw-usertoollinks">(<a href="http://www.spaconference.org/mediawiki/index.php?title=User_talk:Maintenance_script&amp;action=edit&amp;redlink=1" class="new" title="User talk:Maintenance script (page does not exist)">Talk</a>)</span></span></td><td></td></tr>
</table>

</div>
<br /><ul>
<li id="mw-imagepage-edit-external"><a href="./index.php?title=File:BeingLazy1.hs&amp;action=edit&amp;externaledit=true&amp;mode=file" title="File:BeingLazy1.hs">Edit this file using an external application</a> <small>(See the <a href="http://www.mediawiki.org/wiki/Manual:External_editors" class="external text" rel="nofollow">setup instructions</a> for more information)</small></li>
</ul>
<h2 id="filelinks">File links</h2>
<div id='mw-imagepage-section-linkstoimage'>
<p>The following page links to this file:
</p><ul class='mw-imagepage-linkstoimage'>
<li><a href="index.php?title=BeingLazy" title="BeingLazy">BeingLazy</a></li>
</ul>
</div>
<div class="printfooter">
Retrieved from "<a href="./index.php?title=File:BeingLazy1.hs">http://www.spaconference.org/mediawiki/index.php?title=File:BeingLazy1.hs</a>"</div>
...
<div id="column-one">
	<div id="p-cactions" class="portlet">
		...
		<div class="pBody">
			<ul>
				 <li id="ca-nstab-image" class="selected"><a href="./index.php?title=File:BeingLazy1.hs" title="View the file page [c]" accesskey="c">File</a></li>
				 <li id="ca-talk" class="new"><a href="http://www.spaconference.org/mediawiki/index.php?title=File_talk:BeingLazy1.hs&amp;action=edit&amp;redlink=1" title="Discussion about the content page [t]" accesskey="t">Discussion</a></li>
				 <li id="ca-viewsource"><a href="./index.php?title=File:BeingLazy1.hs&amp;action=edit" title="This page is protected.&#10;You can view its source [e]" accesskey="e">View source</a></li>
			</ul>
		</div>
	</div>
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				...
				<li id="pt-anonlogin"><a href="http://www.spaconference.org/mediawiki/index.php?title=Special:UserLogin&amp;returnto=File:BeingLazy1.hs" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in / create account</a></li>
			</ul>
		</div>
	</div>
	...
	<div class="portlet" id="p-tb">
		...
		<div class="pBody">
			<ul>
				<li id="t-whatlinkshere"><a href="./index.php?title=Special:WhatLinksHere%252FFile:BeingLazy1.hs" title="List of all wiki pages that link here [j]" accesskey="j">What links here</a></li>
<li id="t-specialpages"><a href="./index.php?title=Special:SpecialPages" title="List of all special pages [q]" accesskey="q">Special pages</a></li>
				<li id="t-print"><a href="./index.php?title=File:BeingLazy1.hs&amp;printable=yes" rel="alternate" title="Printable version of this page [p]" accesskey="p">Printable version</a></li>			</ul>
		</div>
	</div>
